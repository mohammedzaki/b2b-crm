                    ...
                    <div class="table-responsive">
                        <div class="dataTable_wrapper">
                            <div id="dataTables-example_wrapper"
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        {{ Form::open(['route' => 'financialCustodyItems.store', 'id' => 'financialCustodyItemsForm', "role" => "form"]) }}
                                        <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                               id="financialCustodyItemsTable" role="grid"
    ...
    <script>
        ...
        function AddNewRow(CellChildInput) {
            ...
            if ($(AfterCurrentRow).hasClass("ItemRow") === false) {
                ...
                var rowIndex = $("#financialCustodyItemsTable tr").length - 3;
                console.log(rowIndex);
                client_id = $('#grid_FinancialCustodyDetails tr:eq(' + rowIndex + ') .client_id');
                supplier_id = $('#grid_FinancialCustodyDetails tr:eq(' + rowIndex + ') .supplier_id');
                client_id.empty();
