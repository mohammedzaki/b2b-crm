...
@section('title', 'إصدار شيك ضمان')

@if(empty($bankId))
    @section('form-header', "إصدار شيك ضمان")
@else
    @section('form-header', "إصدار شيك ضمان - {$bankName}")
@endif

@section('select-bank')
    @include('common.select-bank', ['formConfig' => ['method' => 'GET', 'route' => ['bank-cash.guaranteeChequeBook', ''], 'id' => 'SearchForm']])
@endsection
