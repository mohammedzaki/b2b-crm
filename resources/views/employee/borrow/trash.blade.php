@extends('layouts.app') 
@section('title', 'المحذوفات - عملية جديدة عميل') 
@section('content')

<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">عملية جديدة عميل <small>المحذوفات</small></h1>
    </div>
</div>
<!-- /.row -->
	                    ...
	                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                        ...
	                        <tbody>
	                        	...
	                        	<tr role="row">
	                        	    ...
	                        	    <td>
	                        	        {{ link_to_route('client.process.restore', 'استرجاع', array('id' => $process->id), array('class' => 'btn btn-warning')) }}
	                        	    </td>
	                        	</tr>
	                        	@empty
                                    <tr>ﻻ يوجد عمﻻء.</tr>
