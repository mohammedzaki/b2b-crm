	                    ...
	                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                        ...
	                        <tbody>
	                        	...
	                        	<tr role="row">
	                        	    ...
	                        	    <td>{{ $loan->name }}</td>
	                        	    <td>
	                        	        {{ Form::open(['method' => 'DELETE', 'route' => ['loans.destroy', $loan->id], 'onsubmit' => 'return ConfirmDelete()', 'style' => 'display: inline-block;']) }}
	                        	            {{ Form::button('حذف', array('type' => 'submit', 'class' => 'btn btn-danger')) }}
	                        	        {{ Form::close() }}

	                        	        {{ link_to_route('loans.edit', 'تعديل', array('id' => $loan->id), array('class' => 'btn btn-primary')) }}
	                        	    </td>
	                        	</tr>
	                        	@empty
